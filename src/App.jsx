  ...
  return (
    <div>
      ...
      <div className='empleados'>
        <h2>EMPLEADOS</h2>
        <ul className="envoltura">
          {empleados.map((empleado, index) =>
            <li key={index} className="ficha__empleado">
      ...
      <div className="calculadora">
        ...
        <div className='calculadora__botones'>
          <button className="boton" onClick={() => handleCalculate("+")}>SUMAR</button>
          <button className="boton" onClick={() => handleCalculate("-")}>RESTAR</button>
          <button className="boton" onClick={() => handleCalculate("*")}>MULTIPLICAR</button>
          <button className="boton" onClick={() => handleCalculate("/")}>DIVIDIR</button>
        </div>
